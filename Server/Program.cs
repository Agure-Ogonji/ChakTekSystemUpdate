...
using ServerLibrary.Repositories.Implemetations;
using System.Text;
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowBlazorWasm",
        builder => builder.WithOrigins("http://localhost:5038", "https://localhost:7044").AllowAnyMethod().AllowAnyHeader().AllowCredentials());
});
